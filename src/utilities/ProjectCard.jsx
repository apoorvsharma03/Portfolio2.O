  ...
  return (
    ...
    >
      <div className={`relative overflow-hidden transition-all duration-500 ease-in-out text-cyan-600 
        ${!isTouchable && (isFocused ? 'max-w-[500px] h-44 opacity-100' : 'max-w-0 h-44 opacity-0')} 
      ...
      <div className={`flex flex-col gap-2 items-center justify-center transition-all duration-500 ease-in-out overflow-hidden rounded-xl h-44
