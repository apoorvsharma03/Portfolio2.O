  ...
  return (
    ...
    >
      <div className={`relative overflow-hidden transition-all duration-500 ease-in-out text-cyan-600 
        ${!isTouchable && (isFocused ? 'max-w-[500px] md:max-w-[] lg:max-w-[53vw] lgl:max-w-[45vw] xhl:max-w-[45vw] 2xl:max-w-[36vw] lgl:h-[10.5rem] h-40 opacity-100' : 'max-w-0 lgl:h-[10.5rem] h-40 opacity-0')} 
        ...
        <div className={`absolute bottom-[2px] w-full ${isTouchable && 'mt-2'}`}>
