...
const ExperienceCard = ({ props }) => {
  ...
  return (
    <div className='flex flex-col mt-4'>
      <div className='p-4 hover:bg-opacity-20 hover:bg-cyan-900 hover:shadow-2xl transition-all rounded-xl'>
        <div className='flex flex-col md:flex-row justify-between'>
          <div className='flex items-center gap-4'>
            <a href={link}>
              <img src={logo} alt={name} className='w-12'/>
            </a>
            <div>
              <a href={link}>
          ...
          <div className='text-end flex justify-between mt-4 md:mt-0 md:inline'>
        ...
        <div className='flex flex-col mt-4 gap-4 md:flex-row md:gap-0'>
          <div className={`w-${mobileWidth} md:w-[42vw]  text-cyan-600 md:text-left text-justify`}>{description}</div>
