...
const NavigationMenu = () => {
  ...
  return (
    <div id='NAVIGATION MENU' className='sticky top-0 bg-[#0a192f58] backdrop-blur-md shadow-md w-full md:h-16 h-14 flex justify-between md:p-4 px-4 overfloww-hidden z-20'>
