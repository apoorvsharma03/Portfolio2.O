...
const Contact = () => {
  ...
  const handleSubmit = (e) => {
    ...
    const mailtoURL = `mailto:apoorvsharma2603@gmail.com?subject=${encodeURIComponent(formData.subject)}&body=${encodeURIComponent(formData.message)}`;
  ...
  const cardClass = `${transitionClass} ${isVisible ? 'translate-y-0' : ' translate-y-96'}`;
  const headingClass = `${transitionClass} delay-100 ${isVisible ? 'translate-y-0' : ' translate-y-96'}`;
  const formClass = `${transitionClass} delay-300 ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-96 opacity-0'}`;

  return (
    <div  id='CONTACT ME' ref={contactRef} className=' mt-4 overflow-hidden'>
      <div className={`flex justify-center ${cardClass}`}>
        <div className={`w-full md:w-[60vw] bg-opacity-10 bg-cyan-500 shadow-2xl p-4 rounded-t-3xl`}>
          <div className={`rounded-2xl overflow-hidden mb-4 text-center ${headingClass}`}>
            <ContentHeading>CONTACT ME</ContentHeading>
          </div>
          <form className={`space-y-4 md:flex md:flex-col md:items-center ${formClass}`} onSubmit={handleSubmit}>
...
//   const firstLayerClass = `${transitionClass} ${isVisible ? 'translate-y-0' : ' md:translate-y-96'}`;
...
//       <div className={`w-0 md:w-full bg-opacity-10 bg-cyan-500 shadow-2xl rounded-t-3xl mx-auto ${firstLayerClass}`}>
//         <div className={`w-0 md:w-[80vw] bg-opacity-10 bg-cyan-500 shadow-2xl rounded-t-3xl mx-auto ${secondLayerClass}`}>
//           <div className={`flex flex-col items-center ${thirdLayerClass}`}>
//             <div className='w-[100vw] md:w-[60vw]'>
//               <div className={`bg-opacity-10 bg-cyan-500 shadow-2xl p-4 rounded-t-3xl ${contentClass}`}>
